...
export class AdminDetailsComponent implements OnInit {
   ...
   formControlGroup: FormGroup = new FormGroup({
      // Form controls
      firstNameFieldControl: new FormControl(this.adminUser.firstName, [Validators.required]),
      lastNameFieldControl: new FormControl(this.adminUser.lastName, [Validators.required]),
      emailFieldControl: new FormControl(this.adminUser.email, [Validators.email, Validators.required])
   });
