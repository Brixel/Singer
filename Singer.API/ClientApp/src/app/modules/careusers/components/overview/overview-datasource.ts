...
export class OverviewDataSource extends MatTableDataSource<CareUser> {
   ...
   //#region old connect method
   // Had to be removed when switching from "export class OverviewDataSource extends DataSource<CareUser>" to
   //  "export class OverviewDataSource extends MatTableDataSource<CareUser>"
   // Switched to "export class OverviewDataSource extends MatTableDataSource<CareUser>" to enable filtering
   ...
   //#region old paginator and sorting methods

   // was no longer used after switching from "export class OverviewDataSource extends DataSource<CareUser>" to
   // "export class OverviewDataSource extends MatTableDataSource<CareUser>" and removing the connect method
   // Switched to "export class OverviewDataSource extends MatTableDataSource<CareUser>" to enable filtering
