...
public class Registration : IIdentifiable
{
    ...
    public string RegistrationTitle
    {
        get
        {
            return EventRegistrationType switch
            {
                RegistrationTypes.EventSlotDriven => EventSlot.Event.Title,
                RegistrationTypes.DayCare => "Dagopvang",
                RegistrationTypes.NightCare => "Nachtopvang",
                _ => "",
            };
        }
    }
